...
public class RestoranRestServiceImpl implements RestoranRestService{
    ...
    public Mono<String> getRecipe(String menu, String bahan){
        return this.webClient.get().uri("https://api.spoonacular.com/recipes/complexSearch?apiKey=429e44c2234648d0a86ff9d6b85bb8a6&cuisine="+menu+"&excludeIngredients="+bahan).retrieve().bodyToMono(String.class);
