...
public class RestoranServiceImplTest{
    ...
    @Test
    public void whenAddValidRestoranItShouldCallRestoranRepositorySave() throws Exception{
    ...
    public void whenGetRestoranListCalledItShouldReturnAllRestoran() {
        List<RestoranModel> allRestoranInDatabase = new ArrayList<>(); for (int loopTimes = 3; loopTimes > 0; loopTimes--) {
            allRestoranInDatabase.add(new RestoranModel()); }
        when (restoranService.getRestoranList()).thenReturn(allRestoranInDatabase);
        List<RestoranModel> dataFromServiceCall = restoranService.getRestoranList(); assertEquals(3, dataFromServiceCall.size());
    ...
    public void whenGetRestoranByIdCalledByExistingDataItShouldReturnCorrectData() {
        ...
        assertEquals(1, dataFromOptional.getIdRestoran());
    ...
    public void whenChangeRestoranCalledItShouldChangeRestoranData() {
        ...
        assertEquals(1, dataFromServiceCall.getIdRestoran());
    ...
    public void whenDeleteRestoranCalledItShouldDeleteRestoranData(){
        ...
        restoranModel.setIdRestoran((long)1);

        when(restoranDB.findByIdRestoran(1L)).thenReturn(Optional.of(restoranModel));
